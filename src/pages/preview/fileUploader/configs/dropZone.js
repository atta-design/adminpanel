...
export const FileUploaderConfig = {
    'settings': {
        ...
        dropZone: "#dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
        dialogTrigger: "#dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
    }
};