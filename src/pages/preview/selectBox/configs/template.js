...
import Field from '../template/Field.js';
import { products } from '../../../../components/selectBox/data.js';
...
export const SelectBoxConfig = {
    'settings': {
        ...
        id: "custom-templates-select-box",
        valueExpr: "ID",
        displayExpr: "Name",
        dataSource: products,
        ...
        itemRender: Item, //  Accepts a rendering function.
        ...
        fieldRender: Field, //  Accepts a rendering function.
