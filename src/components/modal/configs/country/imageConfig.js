export const FileUploaderConfig = {
    'settings': {
        ...
        dropZone: "#image-dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
        dialogTrigger: "#image-dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
    }
};