export const FileUploaderConfig = {
    'settings': {
        ...
        selectButtonText: "انتخاب کنید", // Default Value: 'Select File'
        ...
        dropZone: "#thumbnail-dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
        dialogTrigger: "#thumbnail-dropzone-external", // Default Value: undefined Type: String | HTMLElement | jQuery
    }
};